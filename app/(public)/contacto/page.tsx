...
const ContactoPage = () => {
  ...
  if (error && !contacts.length) {
    return (
      <Box>
        <PageHero title="Contacto" subtitle="Información de contacto y canales de atención para la comunidad." backgroundImage="/pages-hero/contacto-hero.webp" overlayColor="rgba(67,160,71,0.88)" overlayColorEnd="rgba(46,134,193,0.72)" />
