...
import { ADMIN_ROUTES, REGULATION_CATEGORIES } from '@/constants';
import { Regulation } from '@/types';

const NormativaListPage = () => {
  ...
  return (
    <Box>
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
        <MenuItem
          component={Link}
          href={ADMIN_ROUTES.ADMIN_NORMATIVA_EDITAR(selectedRegulation?.id || '')}
      ...
      <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            ¿Estás seguro que deseas eliminar la ordenanza "{selectedRegulation?.title}"?
          </Typography>
        </DialogContent>
        <DialogActions>
...
export default NormativaListPage;
